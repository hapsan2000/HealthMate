...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ACC = findViewById(R.id.appoint_now_button);
        ACC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent( HomeActivity.this, AppoinmentActivity.class);
                startActivity(intent);
            }
        });
        ImageView ACC2 = findViewById(R.id.bmi);
        ...
        ImageView ACC3 = findViewById(R.id.wellness);
